  ...
  customElements.define(
    ...
    class MediaGallery extends HTMLElement {
      constructor() {
        ...
        const prevButton = this.elements.viewer.querySelector(
          ".slider-button--prev",
        );
        const nextButton = this.elements.viewer.querySelector(
          ".slider-button--next",
        );

        if (prevButton && nextButton) {
          prevButton.addEventListener("click", () =>
            this.changeMediaByArrow(-1),
          );
      ...
      changeMediaByArrow(direction) {
        ...
        const currentIndex = thumbnails.findIndex((thumb) =>
          thumb.querySelector("button")?.hasAttribute("aria-current"),
        );
        ...
        thumbnails[nextIndex].querySelector("button")?.click();
      }
